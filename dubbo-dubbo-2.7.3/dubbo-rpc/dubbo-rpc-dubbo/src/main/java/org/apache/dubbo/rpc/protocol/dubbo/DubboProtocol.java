...
public class DubboProtocol extends AbstractProtocol {
	...
	private ExchangeHandler requestHandler = new ExchangeHandlerAdapter() {
		...
		public CompletableFuture<Object> reply(ExchangeChannel channel, Object message) throws RemotingException {
			...
			/**
			 *   服务端真正执行rpc请求获取结果的地方   invoker: ProtocolFilterWrapper   调用会经过一系列Filter
			 *   最终走到  org.apache.dubbo.rpc.proxy.AbstractProxyInvoker#invoke(org.apache.dubbo.rpc.Invocation)
			 */
	...
	public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
		//dubbo://192.168.200.10:20880/org.apache.dubbo.demo.DemoService?anyhost=true&application=demo-provider&bean.name=org.apache.dubbo.demo.DemoService&bind.ip=192.168.200.10&bind.port=20880&deprecated=false&dubbo=2.0.2&dynamic=true&generic=false&interface=org.apache.dubbo.demo.DemoService&methods=sayHello&pid=9496&qos.port=22222&register=true&release=&side=provider&timestamp=1622539401268
		...
		exporterMap.put(key, exporter);// 将 <key, exporter> 键值对放入缓存中
	...
	private ExchangeServer createServer(URL url) {
		...
		url = URLBuilder.from(url)
				...
				.build();
		//从url获取服务 Transporter 实现,默认netty  dubbo://192.168.200.10:20880/org.apache.dubbo.demo.DemoService?anyhost=true&application=demo-provider&bean.name=org.apache.dubbo.demo.DemoService&bind.ip=192.168.200.10&bind.port=20880&channel.readonly.sent=true&codec=dubbo&deprecated=false&dubbo=2.0.2&dynamic=true&generic=false&heartbeat=60000&interface=org.apache.dubbo.demo.DemoService&methods=sayHello&pid=8976&qos.port=22222&register=true&release=&side=provider&timestamp=1622539726739
